  ...
  static List<Module> getSampleModulesList() {
    return [
      ...
      Module(
        ...
        imageUrl: 'https://via.placeholder.com/400x200/FF5722/FFFFFF?text=HTML+CSS',
        createdBy: 'Web Masters',
        stages: [],
        difficulty: 'beginner',
        estimatedHours: 8,
      ...
      Module(
        ...
        imageUrl: 'https://via.placeholder.com/400x200/FFC107/000000?text=JavaScript',
        createdBy: 'Web Masters',
        stages: [],
        difficulty: 'beginner',
        estimatedHours: 12,
        totalStages: 4,
        totalTasks: 18,
        prerequisites: const ['module_web_1'],
      ...
      Module(
        ...
        imageUrl: 'https://via.placeholder.com/400x200/61DAFB/000000?text=React',
        createdBy: 'Web Masters',
        stages: [],
        ...
        totalStages: 5,
        totalTasks: 20,
        prerequisites: const ['module_web_2'],
      ...
      Module(
        ...
        imageUrl: 'https://via.placeholder.com/400x200/4CAF50/FFFFFF?text=Python',
        createdBy: 'Data Experts',
        stages: [],
        difficulty: 'beginner',
        estimatedHours: 10,
      ...
      Module(
        ...
        imageUrl: 'https://via.placeholder.com/400x200/9C27B0/FFFFFF?text=Pandas',
        createdBy: 'Data Experts',
        stages: [],
        difficulty: 'intermediate',
        estimatedHours: 12,
        totalStages: 4,
        totalTasks: 16,
        prerequisites: const ['module_ds_1'],
      ...
      Module(
        ...
        imageUrl: 'https://via.placeholder.com/400x200/E91E63/FFFFFF?text=UI+Design',
      ...
      Module(
        ...
        imageUrl: 'https://via.placeholder.com/400x200/00BCD4/FFFFFF?text=Mobile+Design',
        ...
        totalStages: 4,
        totalTasks: 14,
        prerequisites: const ['module_ui_1'],
      ...
      Module(
        ...
        imageUrl: 'https://via.placeholder.com/400x200/8BC34A/000000?text=Node.js',
